namespace Domain.Entities
{
    public class ProductEntity : BaseEntity
    {
        ...
        public virtual ICollection<InboundTransferDetailsEntity> InboundTransferDetails { get; set; } = new List<InboundTransferDetailsEntity>();
        public virtual ICollection<OutboundTransferDetailsEntity> OutboundTransferDetails { get; set; } = new List<OutboundTransferDetailsEntity>();
    }
}
