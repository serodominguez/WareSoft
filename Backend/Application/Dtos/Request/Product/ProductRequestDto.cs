...
namespace Application.Dtos.Request.Product
{
    ...
    {
        [StringLength(25, ErrorMessage = "The code must be 1 to 25 characters long.")]
        ...
        [StringLength(25, ErrorMessage = "The material must be 1 to 25 characters long.")]
        public string? Material { get; set; }

        [StringLength(20, ErrorMessage = "The color must be 1 to 20 characters long.")]
