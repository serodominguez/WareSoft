...
namespace Application.Services
{
    public class StoresService : IStoresService
    {
        ...
        public  StoresService(IUnitOfWork unitOfWork, IValidator<StoresRequestDto> validator, IOrderingQuery orderingQuery)
        {
        ...
        public async Task<BaseResponse<IEnumerable<StoresResponseDto>>> ListStores(BaseFiltersRequest filters)
        {
            ...
            try
            {
                var stores =  _unitOfWork.Stores.GetAllQueryable()
                                        .Where(s => s.AUDIT_DELETE_USER == null && s.AUDIT_DELETE_DATE == null);
        ...
        public async Task<BaseResponse<IEnumerable<StoresSelectResponseDto>>> ListSelectStores()
        {
            ...
            try
            {
                var stores = (await _unitOfWork.Stores.GetSelectAsync())
                                                .Where(s => s.STATE == true && s.AUDIT_DELETE_USER == null && s.AUDIT_DELETE_DATE == null);
        ...
        public async Task<BaseResponse<bool>> RegisterStore(int authenticatedUserId, StoresRequestDto requestDto)
        {
            ...
            try
            {
                ...
                store.AUDIT_CREATE_USER = authenticatedUserId;
        ...
        public async Task<BaseResponse<bool>> EditStore(int authenticatedUserId, int storeId, StoresRequestDto requestDto)
        {
            ...
            try
            {
                ...
                var store = StoresMapp.StoresMapping(requestDto);
                store.PK_ENTITY = storeId;
                store.AUDIT_UPDATE_USER = authenticatedUserId;
        ...
        public async Task<BaseResponse<bool>> EnableStore(int authenticatedUserId, int storeId)
        {
            ...
            try
            {
                ...
                response.Data = await _unitOfWork.Stores.UpdateAsync(store);
        ...
        public async Task<BaseResponse<bool>> RemoveStore(int authenticatedUserId, int storeId)
        {
            ...
            try
            {
                ...
                response.Data = await _unitOfWork.Stores.RemoveAsync(store);
