...
namespace Application.Services
{
    public class GoodsIssueService : IGoodsIssueService
    {
        ...
        public async Task<BaseResponse<IEnumerable<GoodsIssueResponseDto>>> ListGoodsIssue(BaseFiltersRequest filters)
        {
            var response = new BaseResponse<IEnumerable<GoodsIssueResponseDto>>();
            try
            {
                var issues = _unitOfWork.GoodsIssue.GetGoodsIssueQueryable();
        ...
        public async Task<BaseResponse<bool>> CancelGoodsIssue(int authenticatedUserId, int issueId)
        {
            ...
            try
            {
                ...
                {
                    var currentStock = await _unitOfWork.Inventory.GetStockByIdAsync(item.IdProduct, issue.IdStore);
