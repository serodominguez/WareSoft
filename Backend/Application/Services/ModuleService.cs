...
namespace Application.Services
{
    public class ModuleService : IModuleService
    {
        ...
        public ModuleService(IUnitOfWork unitOfWork, IActionRepository actionRepository, IRoleRepository roleRepository, IValidator<ModuleRequestDto> validator, IOrderingQuery orderingQuery)
        {
