...
namespace Application.Services
{
    public class RoleService : IRoleService
    {
        ...
        public RoleService(IUnitOfWork unitOfWork, IActionRepository actionRepository, IModuleRepository moduleRepository, IValidator<RoleRequestDto> validator, IOrderingQuery orderingQuery)
        {
