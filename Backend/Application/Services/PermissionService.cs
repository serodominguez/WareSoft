...
namespace Application.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public PermissionService(IPermissionRepository permissionRepository, IUserRepository userRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<BaseResponse<bool>> UpdatePermissions(int authenticatedUserId, List<PermissionRequestDto> permissionsDto)
        {
            ...
            try
            {
                ...
                var result = await _permissionRepository.UpdatePermissionsRangeAsync(listPermissionsUpdate);
        ...
        public async Task<BaseResponse<IEnumerable<PermissionByUserResponseDto>>> ListUserPermissions(int userId)
        {
            ...
            try
            {
                ...
                var permissions = await _permissionRepository.PermissionsByRoleAsync(user.IdRole);
        ...
        public async Task<BaseResponse<IEnumerable<PermissionByRoleResponseDto>>> PermissionsByRole(int roleId)
        {
            ...
            try
            {
                ...
                var permissions = await _permissionRepository.PermissionsByRoleAsync(roleId);
