...
namespace Application.Services
{
    public class UsersService : IUsersService
    {
        ...
        public UsersService(IUnitOfWork unitOfWork, ISecurity security, IValidator<UsersRequestDto> validator, IOrderingQuery orderingQuery)
        {
        ...
        public async Task<BaseResponse<bool>> RegisterUser(int authenticatedUserId, UsersRequestDto requestDto)
        {
            ...
            try
            {
                ...
                user.AUDIT_CREATE_USER = authenticatedUserId;
        ...
        public async Task<BaseResponse<bool>> EditUser(int authenticatedUserId, int userId, UsersRequestDto requestDto)
        {
            ...
            try
            {
                ...
                response.Data = await _unitOfWork.Users.EditUserAsync(authenticatedUserId, user, requestDto.UPDATE_PASSWORD);
                if (response.Data)
                {
                    response.IsSuccess = true;
        ...
        public async Task<BaseResponse<bool>> RemoveUser(int authenticatedUserId, int userId)
        {
            ...
            try
            {
                ...
                user.AUDIT_DELETE_USER = authenticatedUserId;
                user.AUDIT_DELETE_DATE = DateTime.Now;
                user.STATE = false;

                response.Data = await _unitOfWork.Users.RemoveAsync(user);
