...
namespace Api.Controllers
{
    ...
    public class SupplierController : BaseApiController
    {
        ...
        public SupplierController(ISupplierService supplierService, IGenerateExcelService generateExcelService)
        {
        ...
        public async Task<IActionResult> ListSuppliers([FromQuery] BaseFiltersRequest filters)
        {
