<template>
  <div>
    ...
    <CommonModal v-model="modal" :itemId="selectedSupplier?.idSupplier || 0"
      :item="selectedSupplier?.companyName || ''" :action="action" moduleName="supplier" entityName="Supplier" name="Proveedor"
